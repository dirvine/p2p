...
pub enum NetworkError {
    ...
    ConnectionFailed { addr: SocketAddr, reason: Cow<'static, str> },
...
pub enum ConfigError {
    ...
    InvalidValue { field: Cow<'static, str>, reason: Cow<'static, str> },
...
impl Recoverable for P2PError {
    ...
    fn suggested_retry_after(&self) -> Option<Duration> {
        match self {
            ...
            P2PError::Transport(TransportError::ConnectionFailed { .. }) => Some(Duration::from_secs(1)),
            _ => None,
        }
    }
...
impl P2PError {
    ...
    pub fn log(&self) {
        ...
        match self {
            ...
            P2PError::Timeout(_) => warn!("{}", self),
            
            P2PError::Validation(_) |
            P2PError::Config(_) => warn!("{}", self),
...
impl From<crate::adaptive::AdaptiveNetworkError> for P2PError {
    fn from(err: crate::adaptive::AdaptiveNetworkError) -> Self {
        ...
        match err {
            ...
            AdaptiveNetworkError::Serialization(ser_err) => P2PError::Serialization(ser_err.to_string().into()),
            AdaptiveNetworkError::Routing(msg) => P2PError::Internal(format!("Routing error: {}", msg).into()),
            AdaptiveNetworkError::Trust(msg) => P2PError::Internal(format!("Trust error: {}", msg).into()),
            AdaptiveNetworkError::Learning(msg) => P2PError::Internal(format!("Learning error: {}", msg).into()),
            AdaptiveNetworkError::Gossip(msg) => P2PError::Internal(format!("Gossip error: {}", msg).into()),
...
mod tests {
    ...
    fn test_error_display() {
        let err = P2PError::connection_failed(
