    ...
    pub fn validate(&self) -> Result<()> {
        ...
        if self.network.max_connections == 0 {
            return Err(P2PError::Config(ConfigError::InvalidValue {
                ...
                reason: "Must be greater than 0".to_string().into()
            }));
        }
...
mod tests {
    ...
    // Commented out to avoid unsafe code
    // Environment variable tests should be run serially or use a different approach
    // #[test]
