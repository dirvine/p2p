...
impl ProjectsManager {
    ...
    pub async fn upload_document(
        ...
        self.update_project_metadata(&project_id, 1, content.len() as i64).await?;
    ...
    pub async fn download_document(
        ...
        // Log access
        self.log_document_access(document_id, AccessAction::Download).await?;
        
        // Retrieve document content
        let encrypted_content = self.file_chunker.get_file(
            &self.storage,
            &document_id.0,
        ).await?;
