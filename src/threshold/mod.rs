...
impl ThresholdGroupManager {
    ...
    pub async fn create_group(
        ...
        let dkg_result = dkg::run_ceremony(
            config.threshold,
                ...
                GroupAuditEntry {
                    ...
                    operation: GroupOperation::CreateSubgroup {
                        ...
                        subgroup_config: SubgroupConfig {
                            ...
                            threshold: config.threshold,
                            initial_participants: config.participants
                                .iter()
        ...
        self.local_shares.insert(group.group_id.clone(), dkg_result.local_share);
    ...
    pub async fn propose_operation(
        ...
        self.pending_operations.insert(operation_id.clone(), pending_op);
