...
mod performance_tests {
    ...
    async fn test_identity_creation_performance() {
        ...
        assert!(
            ...
            "Identity creation took too long: {:?}",
            duration
        );
    }
    ...
    async fn test_message_sending_throughput() {
        ...
        assert!(
            ...
            "Message throughput too low: {:.2} msg/s",
            messages_per_second
        );
    }
    ...
    async fn test_contact_list_scaling() {
        ...
        println!(
            "Inserted {} contacts in {:?}",
            contact_count, insert_duration
        );
    ...
    async fn test_concurrent_operations() {
        ...
        assert!(
            ...
            "Concurrent operation throughput too low: {:.2} ops/s",
            ops_per_second
        );
    }
